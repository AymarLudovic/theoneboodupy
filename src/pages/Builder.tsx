...
import { Paperclip, Send, Mic, Stars, Plus, WalletCards, Euro, ArrowDown, ChevronRight, Dot } from "lucide-react";
...
const Builder = () => {
    ...
    const [webContainer, setWebContainer] = useState<any>(null); // Ajoutez cette ligne
    ...
    const fetchMessages = async () => {
        if (!appId) {
            ...
            setError("ID de l'application non trouvé.");
            return;
        }
...
<rect width="36" height="24" fill="white"/>
                    ...
                    <div className='fixed bottom-4 left-[30%] flex flex-col gap-1 items-center justify-center'>
                        <div className="flex absolute justify-center items-center gap-1 -mt-28 ">
                    ...
                    <div className="md:w-[600px] h-[130px] mt-18  backdrop-blur-lg border border-[#EEE] rounded-[25px]">
